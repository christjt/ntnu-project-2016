...
In nature one can find many examples of collectives displaying self-organizing behavior.
The collectives range from just a few individuals to millions.
Some examples are flocking behavior in birds, fish schooling, and the complex societies seen among social insects. 
...
Together, the actions of these agents form a collective behavior that can be considered intelligent.  

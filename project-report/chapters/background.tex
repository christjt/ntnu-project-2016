...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.31\textwidth}
		\label{fig:flocking}
		\centering
		\includegraphics[width=\linewidth]{chapters/res/flocking.jpg}
		\caption{Flocking\cite{baxter_flocking.jpg_2008}}
	\end{subfigure}
	\begin{subfigure}[b]{0.31\textwidth}
		\label{fig:scholing}
		\centering
		\includegraphics[width=\textwidth]{chapters/res/schooling.png}
		\caption{Schooling\cite{polyglottus_mockingbird-tales-readings--animal-behavior-5.1.pdf_2011}}
	\end{subfigure}
	\begin{subfigure}[b]{0.31\textwidth}
		\label{fig:social-insects}
		\centering
		\includegraphics[width=\linewidth]{chapters/res/Termites_rush_to_damaged_portion_of_mound.jpg}

...
The third part covers the local communication module and explains the affect it has on the robot system.
...
However, figure \ref{fig:results-env-group-distribution} shows that the size of the robot groups formed are not affected by modifying the difficulty of the environment.
...
Additionally, the message passed around decides the robot group behaviour different connection topologies.

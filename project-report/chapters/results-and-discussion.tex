...
From figure \ref{fig:easy-robots-starved} and figure \ref{fig:hard-robots-starved} one can see that this reduces the amount of robots dying from starvation, but the difference is minuscule.
...
The fitness of a genome is determined by how long the robots live.
The fitness achieved in the easy environment is higher than 
